...
public class PostsApiControllerTest  {
    ...
    @Autowired
    private TestRestTemplate restTemplate;  // rest 요청을 해주는 객체

    @Autowired
    private PostsRepository postsRepository;  // 레포지토리
    ...
    public void Posts_등록() throws Exception{
        ...
        // when
//        ResponseEntity<Long> responseEntity = restTemplate  // Long 타입을 key로 하는 post 요청보내고 응답 받기
